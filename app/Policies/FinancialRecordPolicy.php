...
class FinancialRecordPolicy
{
    ...
    {
        return $user->hasPermissionTo('view financial-records');
    }
    ...
    {
        return $user->hasPermissionTo('create financial-records');
    }
    ...
    {
        return $user->hasPermissionTo('edit financial-records');
    }
    ...
    {
        return $user->hasPermissionTo('delete financial-records');
    }
